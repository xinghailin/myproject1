	...
	<div class="main_right" id="viewList" style="margin-left: 300px; height: 100%;">
		<div class="box">
			<div class="container">
				...
				<h4 style="padding: 8px 0; font-size: 20px;color: red;float: left; margin-left: 355px; margin-top: -220px;">预计支付海运费：${oceanFreight }&nbsp;${carorderDetail.unit }</h4>
				<form name="editForm" id="editForm" method="POST" action="<ufa:url namespace="car-ms" fieldName="UPDATE_CAR_MODEL"/>"
