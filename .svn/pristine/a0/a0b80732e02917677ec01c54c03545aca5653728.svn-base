...
<input id="searchUrl" type="hidden" value='<ufa:url namespace="car-ms" fieldName="PERMISSION_RESOURCE_QUERY_URL"/>' /> 
...
<input id="deleteUrl" type="hidden" value='<ufa:url namespace="car-ms" fieldName="PERMISSION_RESOURCE_DELETE_URL"/>' /> 
