...
<div class="mian_right-new" id="EA">
	<div class="rg_list">
		...
		<li>
		      ...
		      <span style="line-height: 35px;margin-top: 2px;width:300px;"> 
		  	  	<select id="model" name="model" style="line-height: 35px;width:150px;height:40px;">
		  	  	 <option value=''>--请选择--</option>
		       ...
		       <span style="line-height: 35px;margin-top: 2px;width:300px;"> 
		  	  	<select id="version" name="version" style="line-height: 35px;width:150px;height:40px;">
		  	  	  <option value=''>--请选择--</option>
		  	  	...
		  	  	<span style="line-height: 35px;width:300px;margin-top: 2px;">
...
<script type="text/javascript">
    seajs.use("${scriptBasePath}/biz/clientedit.js?r=<%=new Date()%>");
</script>
