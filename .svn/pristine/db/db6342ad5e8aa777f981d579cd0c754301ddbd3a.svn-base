...
<input type="hidden" id="searchUrl"
	value="<ufa:url fieldName="freightApplyUpdatelist" namespace="car-ms"/>">
<input type="hidden" id="repealfreightUrl"
	value="<ufa:url fieldName="repealfreight" namespace="car-ms"/>">
...
<input type="hidden" id="UpdatefreightUrl"
	value="<ufa:url fieldName="Updatefreight" namespace="car-ms"/>">
...
<div class="table_list" >
    <table cellpadding="0" cellspacing="0" class="tb_mian">
        ...
        <tr>
			...
			<th style="text-align:center;word-wrap:break-word;">其他费用1(otherCosts1)</th>
			<th style="text-align:center;word-wrap:break-word;">其他费用2(otherCosts2)</th>
...
<script type="text/javascript">
    seajs.use("${scriptBasePath}/jndAssetlibrarylist/freightApplyUpdatepage.js?v=<%=new Date()%>");
</script>