...
<input type="hidden" id="searchUrl" value="<ufa:url fieldName="SAVE_INVENTORYQUOTATION" namespace="car-ms"/>">
<input type="hidden" id="findListMaxDateUrl" value="<ufa:url fieldName="FINLISTMAXDATE_INVENTORYQUOTATION" namespace="car-ms"/>">
...
<script type="text/javascript">
    seajs.use("${scriptBasePath}/inventoryQuotation/add.js?r=<%=new Date()%>");
</script>