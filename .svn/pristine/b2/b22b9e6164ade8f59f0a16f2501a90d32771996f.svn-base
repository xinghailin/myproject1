			...
			<form name="searchForm" id="searchForm" action="<ufa:url fieldName="CAR_EXPORTEXCEL" namespace="car-ms"/>" method="post" target="hideiframe">
				<ul class="tb_ul02">
					...
					<li>
						...
						<div class="tbul02_right02" style="width: 30%">
							<div class="tab_txt01"><span class="td_01">状态(status)：</span> <span class="td_02" style="margin-top: 4px;"> <select id="status" name="status">
				...
				<div class="btnlist" style="margin-bottom: 20px;">
					<div style="width: 400px; margin: auto;"><a href="javascript:void(0);" id="btnSearch" class="btn63_01">查询</a> <a
						href="<ufa:url fieldName="canadaaddneed" namespace="car-ms"/>" id="btnSearch" class="btn63_01 margin_let10">添加需求</a> <a href="javascript:void(0);" id="btnReset"
...
<div class="table_list" >
    <table cellpadding="0" cellspacing="0" class="tb_mian">
        ...
        <tr>
            ...
            <th style="text-align:center">需求车辆数量</th>
        ...
        <tr>
			...
			<td>{{mallcontractcode}}</td>
             <td>{{_operate id code name mallcontractcode}}</td>
        </tr>
        {{/result}}
        </tbody>
    </table>
...
<script type="text/javascript">
    seajs.use("${scriptBasePath}/jndneed/jndneedlst.js?r=<%=new Date()%>");
</script>