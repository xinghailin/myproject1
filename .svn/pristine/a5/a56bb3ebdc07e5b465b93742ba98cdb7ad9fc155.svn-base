		...
		<div class="box">
			<div class="container">
				...
				<div class="use_bill"><c:if test="${invoice.typebig eq 2}">
					...
					<form id="use_personal"><input type="hidden" id="ret" name="ret" value=""> <input type="hidden" id="id" name="id" value="${invoice.id }">
						<div class="form-inline"><c:if test="${invoice.status eq 1}">
							...
							</c:if> <c:if test="${invoice.status eq 5}">
