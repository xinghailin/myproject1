...
<input type="hidden" id="taskUrl" value="<ufa:url fieldName="CAR_HQ_AUDIT_OF_CAR_MOVE" namespace="car-ms"/>">
...
<div class="mian_right-new" id="EA" style="height: 100%;">
	<div class="rg_list">
		<h1 class="tt_h1" id="He">车辆移库-总部审核</h1>
		<div class="tb_list">
		...
		<li>
		   	...
		   	<li>
		   	  <div class="tab_txt01"><span class="td_01" style="width: 120px;">车辆信息</span></div>
		   	</li>
		...
		<%--    	
		   	...
		   	<li>
		   	  <div class="tab_txt01"><span class="td_01" style="width: 120px;font-weight: bold;">采购信息</span></div>
		   	</li>
		  ...
		  <li>
		  	  <div class="tab_txt01">
		  	  	...
		  	  	<span style="line-height: 35px;width:300px;">${carInfo.sellerprice}&nbsp;</span>
			  ...
			  <li style="width:240px; float:left">
			  	<div class="tab_txt01">		  	   
			  		...
			  		<span class="td_02" style="margin-left:90px">车辆一致性证书<br/>&nbsp;
			  		</span>
			  	</div>
			  </li>
			  <li style="width:240px; float:left">
			  	<div class="tab_txt01">		  	   
			  		...
			  		<span class="td_02" style="margin-left:90px">证件4<br/>&nbsp;
			  		</span>
			  	</div>
			  </li>
		   	<li>
		   	...
		   	<li>
		   	  <div class="tab_txt01">
		   	    ...
		   	    <input type="radio" id="method" name="method" value="1" style="margin-top:10px;" checked="checked"/>&nbsp;&nbsp;审核通过&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<div class="btnlist">
			<div style="width: 500px; margin: auto;">
				<a href="javascript:void(0);" class="btn63_01" id="btnOk">确认提交</a>
...
<script type="text/javascript">
    seajs.use("${scriptBasePath}/controlRepository/car_hq_audit.js?r=<%=new Date()%>");
</script>
