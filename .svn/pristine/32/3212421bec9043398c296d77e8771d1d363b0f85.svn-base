...
<div class="main_right" id="viewList" style="margin-left:300px;width: 1550px;height: 100%;"><head>
    <meta charset="UTF-8">
    <title>付款申请单审核-定金</title>
</head>
<body>
<div class="box">
    <h2 class="buy-title">付款申请单审核-定金</h2>
    <div class="content">
                ...
                <div class="detail">
                    ...
                    <div>
                         <span>
                            <i>定金：</i>
                            <i>(downpay)</i>
                        </span><span style="color:red;font-size:20px;">${ap.downpay}</span><c:out value="${_curr}"></c:out>
                        <c:if test="${ap.status == 3}">预计尾款:${ap.shouldfp}</c:if><c:out value="${_curr}"></c:out>
                    </div>
                </div><div class="detail">
                    <div>
                         <span>
    ...
    <div class="sell-button"><c:if test="${ap.status == 3}"><a href="javascript:void(0);" id="passBtn">
            审核通过
