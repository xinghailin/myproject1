...
<input type="hidden" id="searchUrl" value="<ufa:url fieldName="FIND_INVENTORYQUOTATION_URL" namespace="car-ms"/>">
<input type="hidden" id="skipUrl" value="<ufa:url fieldName="ADD_INVENTORYQUOTATION_PAGE" namespace="car-ms"/>">
...
<script type="text/javascript">
    seajs.use("${scriptBasePath}/inventoryQuotation/find.js?r=<%=new Date()%>");
</script>