define(function(require, exports, module) {
	...
	handlebars.registerHelper('formatstatus1', formatstatus1);
	$(function() {
	...
	function operate(id,status){
		var nbsp = "&nbsp;",edit,html;
		if(status)
		edit = $("<a href='javascript:void(0);' target='_self' name='editBtn' class='btn63_003' id='"+id+"'/>").html('<span>修改开证价</span>');
		else edit = $("<a href='javascript:void(0);' target='_self' name='editBtn' class='btn63_03' id='"+id+"'/>").html('<span>审核</span>');
