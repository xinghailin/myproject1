...
<input type="hidden" id="contractUrl" value="<ufa:url fieldName="contractdetails" namespace="car-ms"/>">
...
<script type="text/javascript">
    seajs.use("${scriptBasePath}/addleasebackcontract/financialcontracts.js?r=<%=new Date()%>");
</script>