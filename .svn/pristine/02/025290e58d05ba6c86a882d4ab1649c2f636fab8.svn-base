...
<input type="hidden" id="taskUrl" value="<ufa:url fieldName="CAR_MOVE_LOGISTIC_END_AUDIT" namespace="car-ms"/>">
...
<div class="mian_right-new" id="EA" style="height: 100%;">
	<div class="rg_list">
		<h1 class="tt_h1" id="He">车辆移库-物流审核（物流结束）</h1>
		<div class="tb_list">
		<form name="editForm" id="editForm" method="POST" action="">
			...
			<h2>物流任务：物流到指定地址后点击"任务完成车辆到店"按钮，等待门店确认</h2>
			...
			<div style="display:inline;margin-left:220px;width: 150px;">
			  <textarea readonly="readonly" style="resize:none;color:red;font: 15px;line-height:65px;vertical-align:middle;height:74px;width: 150px;cursor:pointer;">*运送到店，确认送达</textarea>
			</div>
		...
		<div class="btnlist">
			<div style="width: 500px; margin: auto;">
				<a href="javascript:void(0);" class="btn63_01" id="btnOk">任务完成车辆到店</a>
