...
<input type="hidden" id="searchUrl" value="<ufa:url fieldName="bizzeropurstorequery" namespace="car-ms"/>">
<input type="hidden" id="editUrl" value="<ufa:url fieldName="bizzeropurstore" namespace="car-ms"/>">
...
<th style="text-align:center">版别</th>
            <th style="text-align:center">零采成本价</th>
            <th style="text-align:center">门店结算价</th>
...
<script type="text/javascript">
    seajs.use("${scriptBasePath}/biz/zeropurstorelst.js?r=<%=new Date()%>");
</script>