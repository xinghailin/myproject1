...
<input type="hidden" id="addUrl" value="<ufa:url fieldName="toaddothercase" namespace="car-ms"/>">
		...
		<div class="tb_list">
			<form name="searchForm" id="searchForm">
				...
				<div class="btnlist" style="margin-bottom: 20px;">
					...
					<a href="javascript:void(0);" id="btnAdd" class="btn63_01 margin_let10">新建二抵/其他案件</a>
					</div>
			</div>
		</form>
	</div>
