...
<input type="hidden" id="searchUrl" value="<ufa:url fieldName="FIND_PROCUREMENTWEEKLY_URL" namespace="car-ms"/>">
<input type="hidden" id="skipUrl" value="<ufa:url fieldName="ADD_PROCUREMENTWEEKLY_PAGE" namespace="car-ms"/>">
<input type="hidden" id="viewUrl" value="<ufa:url fieldName="FINDTWOPRICE_PROCUREMENTWEEKLY_PAGE" namespace="car-ms"/>">
			 ...
			 <form name="searchForm" id="searchForm"
				...
				<ul class="tb_ul02">
					<li><input id="currpage" value="${currpage }" type="hidden" />
						...
						<div class="tbul02_right02" style="width: 25%">
							<div class="tab_txt01">
								<span class="td_01">报价日期：</span> <span class="td_02"
									style="margin-top: 4px;"><input class="input_text01"
									name="quoteDate" id="payDateTime" class="input_text01"
				...
				<div class="btnlist" style="margin-bottom: 20px;">
					<div style="width: 400px; margin: auto;">
						...
						<a href="javascript:void(0);" id="skippage"	 class="btn63_02 margin_let10">新增报价</a>
...
<script type="text/javascript">
    seajs.use("${scriptBasePath}/procurementWeeklyQuotation/find.js?r=<%=new Date()%>");
</script>