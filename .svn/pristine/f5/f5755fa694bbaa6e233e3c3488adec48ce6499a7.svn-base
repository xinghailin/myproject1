...
<input type="hidden" id="formUrl" value="<ufa:url fieldName="invoiceeditsave" namespace="car-ms"/>">
</head>
<style>
		...
		<div class="box">
			<div class="container">
				...
				<div class="use_bill"><c:if test="${invoice.typebig eq 2}">
					...
					<form id="use_personal"><input type="hidden" id="conid" name="conid" value="${co.id }"> <input type="hidden" id="id" name="id" value="${invoice.id }"> <input type="hidden" id="currpage" value="${currpage}"> <c:if
							...
							<div class="personal_con">
								<div class="form-inline">
									...
									<div class="form-group newInput vali"><label><span style="color: red">*</span>单位名称：</label> <input type="text" class="form-control" name="name" value="${invoice.companyname}"></div>
									<div class="form-group newInput vali"><label><span style="color: red">*</span>税号：</label> <input type="text" class="form-control" name="tax" value="${invoice.taxnum}"></div>
									<div class="form-group newInput vali"><label><span style="color: red">*</span>开户行：</label> <input type="text" class="form-control" name="bank" value="${invoice.openbank}"></div>
									<div class="form-group newInput vali"><label><span style="color: red">*</span>银行卡号：</label> <input type="text" class="form-control" name="bankCard" value="${invoice.banknum}" oninput="user(this)"></div>
									<div class="form-group newInput vali"><label><span style="color: red">*</span>经营地址：</label> <input type="text" class="form-control" name="address" value="${invoice.runaddress}"></div>
									<div class="form-group newInput vali"><label><span style="color: red">*</span>联系电话：</label> <input type="text" class="form-control" name="phone" value="${invoice.phone}"></div>
							</div>
