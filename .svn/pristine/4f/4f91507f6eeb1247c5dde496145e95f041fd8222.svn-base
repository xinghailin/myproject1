...
<input type="hidden" id="searchUrl" value="<ufa:url fieldName="WHOLESALE_NOPASSLISTFORFINANCE_METHOD" namespace="car-ms"/>">
...
<script type="text/javascript">
    seajs.use("${scriptBasePath}/wholesale/financeNoPassList.js?r=<%=new Date()%>");
</script>