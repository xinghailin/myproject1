...
<input type="hidden" id="searchUrl" value="<ufa:url fieldName="WHOLESALE_CARLOOK_METHOD" namespace="car-ms"/>">
...
<div class="table_list" >
    <table cellpadding="0" cellspacing="0" class="tb_mian">
        ...
        <tr>
            ...
            <th style="text-align:center;word-wrap:break-word;">审批通过时间</th>
        ...
        <tr>
            ...
            <td>{{_formatSimpleDate modifytime}}</td>
...
<script type="text/javascript">
    seajs.use("${scriptBasePath}/wholesale/lookList.js?r=<%=new Date()%>");
</script>