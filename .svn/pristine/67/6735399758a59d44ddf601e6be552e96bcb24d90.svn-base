...
<div class="box">
    <div class="container">
        ...
        <form name="editForm" id="editForm" method="POST" enctype="multipart/form-data" class="upload" action="<ufa:url namespace="car-ms" fieldName="bizcontractshopaudit"/>">
        ...
        <div class="form-inline">
            <div class="form-group newInput du-choose-category">
                ...
                <label class="radio-inline" style="margin-right: 20px">
                    <input type="radio" name="zeropur" id="inlineRadio1" value="1" disabled="disabled">是
                </label>
                <label class="radio-inline">
                    <input type="radio" name="zeropur" id="inlineRadio2" value="2" disabled="disabled">否
                </label>
            </div>
        </div>
        <div class="form-inline">
...
<script>
seajs.use("${scriptBasePath}/biz/contractonlyview.js");
</script>
</html>