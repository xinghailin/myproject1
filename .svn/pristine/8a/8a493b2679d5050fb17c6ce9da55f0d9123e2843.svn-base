...
<input type="hidden" id="auditUrl" value="<ufa:url fieldName="SNAKER_HQFINANCEFIRSTPAYDO" namespace="car-ms"/>">
<input type="hidden" id="searchUrl" value="<ufa:url fieldName="COMMU_LISTDO" namespace="car-ms"/>">
<div class="mian_right-new" id="EA">
	<div class="rg_list">
		<h1 class="tt_h1" id="He">首付核实</h1>
		<div class="tb_list">
		<ul class="tb_ul02">
		<form name="editForm" id="editForm" method="POST" action="<ufa:url namespace="car-ms" fieldName="SNAKER_HQFINANCEFIRSTPAYDO"/>" enctype="multipart/form-data">
		...
		<li>
		  	  <div class="tab_txt01">
		        <span class="td_01" style="width: 120px;">车辆用途：</span>
		  	  	<span style="line-height: 35px;width:300px;">${buyer.usefor}&nbsp;</span>
		...
		<li>
		        ...
		        <span class="td_01" style="width: 120px;">最低销售价：</span>
		  	  	...
		  	  	<span style="line-height: 35px;width:300px;">${contract.salePrice}&nbsp;</span>
		  	  	<span class="td_01" style="width: 120px;">定金金额：</span>
		  	  	<span style="line-height: 35px;width:300px;">${contract.downpay}&nbsp;</span>
		  	  	<span class="td_01" style="width: 120px;"><label class="fc_red">*</label>实到定金金额：</span>
		  	  	<span style="line-height: 35px;width:300px;"><input type="text" id="realdownpay" name="realdownpay" value="" />&nbsp;</span>
			 </div>
		   	</li>  --%>
		   	<li>
		  	<div class="tab_txt01">
		...
		<li>
		   	...
		   	<li>
		  	  <div class="tab_txt01" style="">
		  	  	<span class="td_01" style="width: 120px;font-weight: bold;">车辆信息</span>
		  	  	</div></li>
		  	<li>
		  	  <div class="tab_txt01">
		...
		<li>
		  	  <div class="tab_txt01" style="">
		  	  	<span class="td_01" style="width: 120px;font-weight: bold;">沟通详情</span>
		  	  	</div></li>
		<li>
		...
		<div class="nodata hide" id="J_NoDataMsg">
			<p>暂无沟通详情。</p>
		   	...
		   	<li>
		  	  <div class="tab_txt01"><span class="td_01" style="width: 120px;font-weight: bold;">首付款</span>
		  	  </div>
		   	</li>
		   	<li>
		  	  <div class="tab_txt01">
		  	  	<span class="td_01" style="width: 120px;color: red;">定金金额：</span>
		  	  	<span style="line-height: 35px;width:300px;colore:red;"><input type="hidden" id="downpay" name="downpay" value="${contract.downpay}" />${contract.downpay}&nbsp;元</span>
		  	  	<span class="td_01" style="width: 120px;">实到定金金额：</span>
		  	  	<span style="line-height: 35px;width:300px;"><input type="text" id="realdownpay" name="realdownpay" value="" />&nbsp;元</span>
			 </div>
		   	</li>
		  </form>
		</ul>
		...
		<div class="btnlist">
		<div style="width: 300px; margin: auto;"><a href="javascript:void(0);" class="btn63_01" id="saveBtn">审核通过</a>
		<a id='noBtn' href="javascript:void(0);" class="btn63_02 margin_let10">审核不通过</a>
...
<script type="text/javascript">
    seajs.use("${scriptBasePath}/outRepository/financeaudit.js?r=<%=new Date()%>");
</script>
