...
<div class="main_right" id="viewList" style="margin-left:300px;width: 1550px;height: 100%;"><head>
    <meta charset="UTF-8">
    <title>付款申请单审核查看</title>
</head>
<body>
<div class="box">
    <h2 class="buy-title">付款申请单审核查看</h2>
    <div class="content">
                ...
                <div class="detail">
                    ...
                    <div>
                         ...
                         <span>
                            <i>尾款：</i>
                            <i>(finalpay)</i>
                        </span><span>${ap.finalpay}<c:out value="${_curr}"></c:out></span>
                    </div>
...
<script type="text/javascript">
    seajs.use("${scriptBasePath}/jnd/payapplyauditview.js?r=<%=new Date()%>");
</script>