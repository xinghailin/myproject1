...
<input type="hidden" id="searchUrl" value="<ufa:url fieldName="tempsavecarList" namespace="car-ms"/>">
<input type="hidden" id="editUrl" value="<ufa:url fieldName="GoToTheLibraryInspectionPage" namespace="car-ms"/>">
<input type="hidden" id="typeinUrl" value="<ufa:url fieldName="queryjndcarById" namespace="car-ms"/>">
...
<div class="main_right" id="viewList" style="margin-left:300px;width: 1550px;height: 100%;">
	<div class="rg_list">
	 <input type="hidden" id="currpage" name="currpage" value="${currpage }"/>
		<div class="tb_list">
		  <form name="searchForm" id="searchForm" action="<ufa:url fieldName="BondedWarehouseEntryList" namespace="car-ms"/>" method="post" target="hideiframe">	    
					<ul class="tb_ul02"> 
				 <li>
					...
					<div class="tbul02_left02" style="width:30%;">
						<div class="tab_txt01">
							<span class="td_01" >车辆所在地：</span> 
							<select id="energytype" name="energytype" style="width: 180px;height:25px;">
					...
					<div class="tbul02_left02" style="width:30%">
						<div class="tab_txt01">
							...
							<span class="td_02" style="margin-top: 4px;">
							<input name="leavefactime1" id="leavefactime" class="input_text01" type="text" style="width:180px;"></span>
						</div>
					</div>
					<div class="tbul02_left02" style="width: 30%;">
							<div class="tab_txt01">
								<span class="td_01">商城合同编号：</span>
								<span class="td_02" style="margin-top: 4px;">
		...
		<span id="carp2" style="color: red;font-family: "新宋体"" >
			</span>
			</div>
...
<div class="table_list" >
    <table cellpadding="0" cellspacing="0" class="tb_mian">
        ...
        <tr>
            ...
            <th style="text-align:center;word-wrap:break-word;">最近修改时间</th>
...
<td>{{_formatDatetime modifytime}}</td>
...
<script type="text/javascript">
    seajs.use("${scriptBasePath}/jndAssetlibrarylist/tempsavecarList.js");
</script>