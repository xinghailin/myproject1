...
<input type="hidden" id="searchUrl" value="<ufa:url fieldName="CAR_AUDIT_LST_DO" namespace="car-ms"/>">
<input type="hidden" id="auditUrl" value="<ufa:url fieldName="CAR_AUDIT" namespace="car-ms"/>">
...
<script type="text/javascript">
    seajs.use("${scriptBasePath}/assetRepository/auditlst.js?r=${ts}");
</script>