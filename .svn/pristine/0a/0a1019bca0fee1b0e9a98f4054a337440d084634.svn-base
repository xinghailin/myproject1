...
<input type="hidden" id="toauditUrl" value="<ufa:url fieldName="jndpayapplyauditone" namespace="car-ms"/>">
...
<option value="1">定金通过</option><option value="2">定金不通过</option><option value="3">定金待审核</option>
<option value="5">尾款通过</option><option value="6">尾款不通过</option><option value="7">尾款待审核</option>
</select>
</span>		
						</div>
					</div>
...
<div class="table_list" >
    <table cellpadding="0" cellspacing="0" class="tb_mian">
        ...
        <tr>
			...
			<th style="text-align:center;word-wrap:break-word;">版别(model)</th>
...
<th style="text-align:center;word-wrap:break-word;">付款创建时间(createTime)</th>
            ...
            <th style="text-align:center;word-wrap:break-word;width:120px;">操作(operate)</th>
        </tr>
        </thead>
        <tbody>
        {{#result}}
...
<script type="text/javascript">
    seajs.use("${scriptBasePath}/jnd/payapplyauditlst.js?v=<%=new Date()%>");
</script>