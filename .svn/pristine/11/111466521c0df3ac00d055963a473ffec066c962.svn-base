...
<input type="hidden" id="addinsuranceUrl"
	...
	<input type="hidden" id="selectcarUrl"
	value="<ufa:url fieldName="fselectcar" namespace="car-ms"/>">
...
<td>{{_formatDatetime createtime}}</td>
            <td>{{formatstatus status status2}}</td>
...
<script type="text/javascript">
    seajs.use("${scriptBasePath}/addleasebackcontract/financialselectcar.js?r=<%=new Date()%>");
</script>