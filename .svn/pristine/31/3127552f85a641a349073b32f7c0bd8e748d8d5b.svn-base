	...
	<div class="main_right" id="viewList" style="margin-left: 300px; height: 100%;">
		<div class="box">
			<div class="container kv-main">
				...
				<form name="editForm" id="editForm" method="POST" enctype="multipart/form-data" class="upload" action="<ufa:url namespace="car-ms" fieldName="casesave5"/>"><input type="hidden" id="id" name="id" value="${riskcase.id}"> <input type="hidden" id="currpage" name="currpage"
					...
					<div class="form-inline">
						...
						<div class="form-group newInput"><label style="font-weight: normal;">判决书：</label><input id="book" name="book" type="file" style="display: inline-block"></div>
						<div class="form-group newInput"><label style="font-weight: normal;">判决生效时间：</label> <label class="radio-inline"> <input id="judgetime1" name="judgetime1" type="text" placeholder="请选择时间" readonly="readonly" style="display: inline-block">
						</label></div>
				</div></form>
