...
<input type="hidden" id="searchUrl" value="<ufa:url fieldName="invoicelistfinancequery" namespace="car-ms"/>">
...
<div id="J_Pagination"  class="pagelist"></div>
    ...
    seajs.use("${scriptBasePath}/biz/invoicefinancelst.js?r=<%=new Date()%>");
</script>