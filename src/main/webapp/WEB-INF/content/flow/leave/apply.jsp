		...
		<form id="inputForm" action="${ctx }/snaker/flow/process" method="post" target="mainFrame">
			...
			<table class="table_all" align="center" border="0" cellpadding="0" cellspacing="0" style="margin-top: 0px">
				...
				<%-- <tr>
					...
					<td class="td_table_2" colspan="3">
					    <select name="S_approveDept.operator" class="input_240">
					        <option value="${dept.loginName }">11</option>
					        <option value="${dept.loginName }">22</option>
					        <option value="${dept.loginName }">33</option>
					        <option value="${dept.loginName }">44</option>
					    </select>
					...
					<td class="td_table_2" colspan="3">
					    <select name="S_approveDept.operator" class="input_240">
					      <c:forEach var="dept" items="${deptList }">
					        <option value="${dept.loginName }">${dept.name }</option>
					      </c:forEach>					      
					    </select>
						<%-- <input type="text" class="input_240" name="S_approveDept.operator" value="${operator}" /> --%>
					</td>
				...
				<tr>
					...
					<td class="td_table_2" colspan="3">
						<input type="text" class="input_240" name="S_approveBoss.operator" value="${boss.loginName}" />
					</td>
				</tr>
				<tr>
