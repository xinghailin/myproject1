...
<input type="hidden" id="subbuyIndexUrl" value="<ufa:url fieldName="jndSubPurchaseLstForApayIndex" namespace="car-ms"/>">
		  ...
		  <form name="searchForm" id="searchForm">	    
			<ul class="tb_ul02">
				...
				<div class="tbul02_right02" style="width:30%">
						<div class="tab_txt01">
							<span class="td_01">采购计划编号：</span> <span class="td_02"
					...
					<div class="tbul02_left02" style="width:30%">
						<div class="tab_txt01">
							<span class="td_01">采购计划名称：</span> <span
					...
					<div class="tbul02_left02" style="width:30%">
						<div class="tab_txt01">
							<span class="td_01">采购计划创建时间：</span> <span
...
<th style="text-align:center">采购车辆数量</th>
            <th style="text-align:center">采购计划创建时间</th>
            <th style="text-align:center">需求编号</th>
			<th style="text-align:center">需求名称</th>
			<th style="text-align:center">需求车辆数量</th>
            <th style="text-align:center">需求创建时间</th>
        </tr>
        </thead>
        <tbody>
        {{#result}}
...
<script type="text/javascript">
    seajs.use("${scriptBasePath}/jnd/purchaselstforapay.js?v=<%=new Date()%>");
</script>