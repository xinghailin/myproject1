...
<input type="hidden" id="auditCarSourceUrl" value="<ufa:url fieldName="auditCarSource" namespace="car-ms"/>">
					...
					<li><div class="tbul02_left02" style="width: 30%;margin-left: 100px;">
						...
						<div class="tbul02_left02" style="width: 30%;">
							<div class="tab_txt01">
								...
								<span class="td_02" style="margin-top: 4px;">
									<select name="status" style="text-align: center;width: 180;height: 28px;">
...
<div class="table_list" >
    <table cellpadding="0" cellspacing="0" class="tb_mian">
        ...
        <tr>
			...
			<td>{{_operate id status endtime}}</td>
        </tr>
        {{/result}}
        </tbody>
    </table>
...
<script type="text/javascript">
 function citys() {
    ...
    seajs.use("${scriptBasePath}/carsource/auditCarSourcelistpage.js?r=<%=new Date()%>");
</script>