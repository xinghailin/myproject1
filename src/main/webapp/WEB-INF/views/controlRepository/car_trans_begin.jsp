...
<input type="hidden" id="taskUrl" value="<ufa:url fieldName="CAR_MOVE_LOGISTIC_BEGIN_AUDIT" namespace="car-ms"/>">
...
<div class="mian_right-new" id="EA" style="height: 100%;">
	<div class="rg_list">
		<h1 class="tt_h1" id="He">车辆移库-物流审核（开始物流）</h1>
		<div class="tb_list">
		<form name="editForm" id="editForm" method="POST" action="">
			...
			<h2>物流任务：物流车辆到指定地址</h2>
			<div style="display:inline;margin-left:20px;height:74px;width: 150px;">
			  <textarea readonly="readonly" style="resize:none;font: 15px;color:red;line-height:65px;vertical-align:middle;height:74px;width: 150px;cursor:pointer;">*接受任务开始物流</textarea>
			</div>
			...
			<div style="display:inline;margin-left:250px;width: 150px;">
			  <textarea readonly="readonly" style="resize:none;font: 15px;line-height:65px;vertical-align:middle;height:74px;width: 150px;cursor:pointer;">门店确认，任务完成</textarea>
			</div>
		<ul class="tb_ul02">
	...
	<%-- 	<li>
		  ...
		  <li>
		  	  <div class="tab_txt01">
		  	  	...
		  	  	<span style="line-height: 35px;width:200px;">${carInfo.sellerprice }&nbsp;</span>
			 </div>
		   	</li><li>
		  	  <div class="tab_txt01">
		...
		<div class="btnlist">
			<div style="width: 500px; margin: auto;">
				<a href="javascript:void(0);" class="btn63_01" id="btnOk">接受任务开始物流</a>
