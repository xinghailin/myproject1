...
<div class="box">
    <div class="container">
        ...
        <form name="editForm" id="editForm" method="POST" class="upload" action="<ufa:url namespace="car-ms" fieldName="bizcontractvin"/>">
        <input type="hidden" id="id" name="id" value="${co.id}">
        <input type="hidden" id="zeropur" name="zeropur" value="${co.zeropur}">
        ...
        <div class="form-inline"><div class="form-group newInput" style="width:33%;">
        <label>车辆销售合同：</label>
        ...
        <div class="form-inline">
            <div class="form-group newInput" style="width:33%;">
                <label>是否零采：</label>${co.zeropur eq '1'?'是':'否'}
            </div>
            <div class="form-group newInput" style="width:33%;">
                <label>门店部审核：</label>通过
            </div>
            <div class="form-group newInput" style="width:33%;">
                <label>状态：</label>定金已到账
            </div>
        </div>
        <div class="form-inline">
        	<div class="form-group newInput">
            <label>车架号：</label><input type="hidden" id="carid" name="carid" value=""><input type="text" id="vin" name="vin" value="" readonly="readonly" class="form-control"><a href="javascript:;" class="btn btn-danger" role="button" id="chooseBtn">选车</a>
            </div>
        </div>
        </form>
        <div class="du-btn">
            <a href="javascript:;" class="btn btn-danger" role="button" style="padding: 6px 30px" id="saveBtn">确定</a>
            <a href="javascript:;" class="btn btn-warning" role="button" style="padding: 6px 30px" id="backBtn">返回</a>
        </div>
    </div>
</div>
</div>
