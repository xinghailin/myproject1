...
<input type="hidden" id="searchUrl" value="<ufa:url fieldName="shopconfirmedlist" namespace="car-ms"/>">
...
<script type="text/javascript">
    seajs.use("${scriptBasePath}/addleasebackcontract/shopconfirmedlistpage.js?r=<%=new Date()%>");
</script>