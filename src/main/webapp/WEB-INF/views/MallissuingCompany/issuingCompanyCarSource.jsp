...
<input type="hidden" id="issuingid" name="issuingid" value="${id }">
			...
			<form name="searchForm" id="searchForm">
				...
				<ul class="tb_ul02">
					...
					<div class="tbul02_left02" style="width: 25%">
							<div class="tab_txt01">
								<span class="td_01">地区：</span>
								<span class="td_02" style="margin-top: 4px;">
									<input name="areaname" id="areaname" class="input_text01" type="text" style="width: 180px;">
								</span>
							</div>
						</div>
						<div class="tbul02_left02" style="width: 25%">
...
<script type="text/javascript">
    seajs.use("${scriptBasePath}/MallissuingCompany/issuingCompanyCarSource.js?r=<%=new Date()%>");
</script>