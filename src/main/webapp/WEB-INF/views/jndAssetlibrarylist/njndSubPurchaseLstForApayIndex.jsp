...
<input type="hidden" id="addUrl" value="<ufa:url fieldName="njndApplyPayAdd" namespace="car-ms"/>">
				 ...
				 <div class="tbul02_right02" style="width:30%">
						<div class="tab_txt01">
							<span class="td_01" style="width: 220px;">付款创建时间(createTime)：</span> <span class="td_02"
								style="margin-top: 4px;"><input class="input_text01" name="ccreatetime" id="ccreatetime"
								class="input_text01" type="text" style="width:180px;"></span>
						</div>
					</div>
					</li><li> 
