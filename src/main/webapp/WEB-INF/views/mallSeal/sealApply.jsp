...
<input type="hidden" id="searchUrl" value="<ufa:url fieldName="MALL_SEALAPPLY_METHOD" namespace="car-ms"/>">
<input type="hidden" id="checkUrl" value="<ufa:url fieldName="MALL_SEALAPPLYCHECK_PAGE" namespace="car-ms"/>">
...
<script type="text/javascript">
    seajs.use("${scriptBasePath}/mallSeal/sealApply.js?r=<%=new Date()%>");
</script>