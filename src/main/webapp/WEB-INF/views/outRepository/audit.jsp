...
<input type="hidden" id="auditUrl" value="<ufa:url fieldName="SNAKER_HQCONTRACTDO" namespace="car-ms"/>">
<input type="hidden" id="searchUrl" value="<ufa:url fieldName="COMMU_LISTDO" namespace="car-ms"/>">
<div class="mian_right-new" id="EA">
	<div class="rg_list">
		<h1 class="tt_h1" id="He">客户信息表&车辆销售合同</h1>
		<div class="tb_list">
		<ul class="tb_ul02">
		<form name="editForm" id="editForm" method="POST" action="<ufa:url namespace="car-ms" fieldName="SNAKER_HQCONTRACTDO"/>">
...
<script type="text/javascript">
    seajs.use("${scriptBasePath}/outRepository/audit.js?r=<%=new Date()%>");
</script>
