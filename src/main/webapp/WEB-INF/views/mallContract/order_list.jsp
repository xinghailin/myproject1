...
<input type="hidden" id="searchUrl" value="<ufa:url fieldName="MALL_LOOKORDERBYCONTRACT_METHOD" namespace="car-ms"/>">
<input type="hidden" id="lookUrl" value="<ufa:url fieldName="MALL_LOOKCARBYORDER_PAGE" namespace="car-ms"/>">
<input type="hidden" id="backUrl" value="<ufa:url fieldName="MALL_CONTRACT_LISTPAGE" namespace="car-ms"/>">
	...
	<div class="rg_list">
		...
		<div class="tb_list">
			<form name="searchForm" id="searchForm"
				...
				target="hideiframe">
				<input type="hidden" id = "sealapplycode" name = "sealapplycode" value = "${sealapplycode}">
				<ul class="tb_ul02">
					<li>
...
<div class="table_list" >
    <table cellpadding="0" cellspacing="0" class="tb_mian" id="001">
        ...
        <tr>
            ...
            <th style="text-align:center;word-wrap:break-word;">数量</th>
...
<script type="text/javascript">
    seajs.use("${scriptBasePath}/mallContract/order_list.js?r=<%=new Date()%>");
</script>