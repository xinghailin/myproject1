		...
		<div class="box">
			<div class="container">
				...
				<div class="use_bill"><c:if test="${invoice.typebig eq 2}">
					...
					<div class="form-inline">
						<div class="form-group newInput vali"><label><span style="color: red">*</span>结算车价：</label> <input type="text" class="form-control" name="settlementcarprice"
							value="${invoice.settlementcarprice}" readonly="readonly"></div>
						<div class="form-group newInput vali"><label><span style="color: red">*</span>购置税：</label> <input type="text" class="form-control" name="purchasetax"
							value="${invoice.purchasetax}" readonly="readonly"></div>
						<div class="form-group newInput vali"><label><span style="color: red">*</span>保险：</label> <input type="text" class="form-control" name="insurance"
							value="${invoice.insurance}" readonly="readonly"></div>
						<div class="form-group newInput vali"><label><span style="color: red">*</span>上牌费：</label> <input type="text" class="form-control" name="plateprice"
							value="${invoice.plateprice}" readonly="readonly"></div>
						<div class="form-group newInput vali"><label>其他1：</label> <input type="text" class="form-control" id="other1price" name="other1price" value="${invoice.other1price}"
							readonly="readonly"></div>
						<div class="form-group newInput vali"><label>备注1：</label> <input type="text" class="form-control" id="other1description" name="other1description"
							value="${invoice.other1description}" readonly="readonly"></div>
						<div class="form-group newInput vali"><label>其他2：</label> <input type="text" class="form-control" id="other2price" name="other2price" value="${invoice.other2price}"
							readonly="readonly"></div>
						<div class="form-group newInput vali"><label>备注2：</label> <input type="text" class="form-control" id="other2description" name="other2description"
							value="${invoice.other2description}" readonly="readonly"></div>
				</div>
					...
					<form id="use_personal"><input type="hidden" id="ret" name="ret" value=""> <input type="hidden" id="id" name="id" value="${invoice.id }">
						<div class="form-inline">
							<div class="form-group newInput vali"><label><span style="color: red">*</span>结算车价：</label> <input type="text" class="form-control" name="fsettlementcarprice"
								value="${invoice.fsettlementcarprice}"></div>
							<div class="form-group newInput vali"><label><span style="color: red">*</span>购置税：</label> <input type="text" class="form-control" name="fpurchasetax"
								value="${invoice.fpurchasetax}"></div>
							<div class="form-group newInput vali"><label><span style="color: red">*</span>保险：</label> <input type="text" class="form-control" name="finsurance"
								value="${invoice.finsurance}"></div>
							<div class="form-group newInput vali"><label><span style="color: red">*</span>上牌费：</label> <input type="text" class="form-control" name="fplateprice"
								value="${invoice.fplateprice}"></div>
							...
							<div class="form-group newInput vali"><label>备注1：</label> <input type="text" class="form-control" id="fother1description" name="fother1description"
								value="${invoice.fother1description}"></div>
							...
							<div class="form-group newInput vali"><label>备注2：</label> <input type="text" class="form-control" id="fother2description" name="fother2description"
								value="${invoice.fother2description}"></div>
					</div>
						<div class="form-inline">
							...
							<div class="form-group newInput"><label>不通过原因：</label> <textarea class="form-control" rows="4" style="resize: none; min-width: 300px" id="du-reason2"
								name="fnopassreason">${invoice.fnopassreason}</textarea></div>
					</div></form>
