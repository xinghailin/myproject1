...
<input type="hidden" id="stepflow" value="${stepflow}">
					...
					<div class="tbul02_left02" style="width:30%">
						<div class="tab_txt01">
							<span class="td_01">车架号：</span> <span
								...
								class="input_text01" type="text" style="width:180px;" value="${vin}"></span>
						</div>
					</div>
				</li>
				<li>
...
<script type="text/javascript">
    seajs.use("${scriptBasePath}/biz/chooserealSale.js?r=<%=new Date()%>");
</script>