...
<input type="hidden" id="formUrl" value="<ufa:url fieldName="batchinvoicesave" namespace="car-ms"/>">
	...
	<div class="main_right" id="viewList" style="margin-left: 300px; height: 100%;">
		<div class="box">
			<div class="container">
				...
				<form action="kp.php" id="add_form"><input type="hidden" id="conid" name="conid" value="${ws.id }">
				...
				<div class="use_bill" style="display: none">
					...
					<form action="kp.php" id="use_personal"><input type="hidden" id="conid" name="conid" value="${ws.id }">
					...
					<form action="kp.php" id="use_company"><input type="hidden" id="conid" name="conid" value="${ws.id }">
