...
<input type="hidden" id="searchUrl" value="<ufa:url fieldName="invoicelistquery" namespace="car-ms"/>">
...
<div id="J_Pagination"  class="pagelist"></div>
    ...
    seajs.use("${scriptBasePath}/biz/invoicelst.js?r=<%=new Date()%>");
</script>