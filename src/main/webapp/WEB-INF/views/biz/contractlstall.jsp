...
<input type="hidden" id="editUrl" value="<ufa:url fieldName="bizcontractview" namespace="car-ms"/>">
...
<div class="tab_txt01">
	<span class="td_01">档案编号：</span> <span
		class="td_02" style="margin-top: 4px;"><input name="filecode"
...
<div class="tab_txt01">
	<span class="td_01">甲方：</span> <span class="td_02"
		style="margin-top: 4px;"><input class="input_text01" name="name" 
class="input_text01" type="text" style="width:180px;"></span>
	</div>
</div>
<div class="tbul02_left02" style="width:30%">
...
<input name="bname" class="input_text01" type="text" style="width:180px;"></span>
		</div>
	</div>
</li>
<li>
<div class="tbul02_left02">
 <div class="tab_txt01"><span class="td_01">客户类别：</span>
<span class="td_05" style="margin-top: 6px;">
	<select name="workType"><option value="">--请选择--</option>
        <option value="1">个人</option><option value="2">单位</option>
    </select>
	</span>
	</div>
</div>
<div class="tbul02_left02" style="width:30%">
<div class="tab_txt01">
	<span class="td_01">身份证号：</span> <span
		class="td_02" style="margin-top: 4px;">
<input name="identify" class="input_text01" type="text" style="width:180px;"></span>
		</div>
	</div>			  					
</li>
</ul>
...
<script type="text/javascript">
    seajs.use("${scriptBasePath}/biz/contractlstall.js");
</script>