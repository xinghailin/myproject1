...
<input type="hidden" id="searchUrl" value="<ufa:url fieldName="bizclientinfoquery_shopGroup" namespace="car-ms"/>">
<input type="hidden" id="viewUrl" value="<ufa:url fieldName="bizclientinfoallview" namespace="car-ms"/>">
...
<script type="text/javascript">
    seajs.use("${scriptBasePath}/biz/clientlstall_shopgroup.js");
</script>