	...
	<div class="main_right" id="viewList" style="margin-left: 300px; height: 100%;">
		<div class="box">
			<div class="container kv-main">
				...
				<div class="form-inline"><c:if test="${not empty riskcase.f1}"><div class="form-group newInput"><label>文件1：</label><a href="${contextPath}${riskcase.f1 }" class="btn btn-primary" download="${riskcase.f1 }" role="button">下载 </a></div></c:if>
...
<div class="form-group newInput"><label>情况描述：</label> ${riskcase.note }</div></div>  <input type="hidden" id="id" name="id" value="${riskcase.id}"> <input type="hidden" id="status"
...
<script>
	seajs.use("${scriptBasePath}/biz/casetheview.js");
</script>
</html>