	...
	<div class="main_right" id="viewList" style="margin-left: 300px; height: 100%;">
		<div class="box">
			<div class="container kv-main">
				<h3 class="title">新建融资租赁逾期案件</h3>
				<form name="editForm" id="editForm" method="POST" enctype="multipart/form-data" class="upload" action="<ufa:url namespace="car-ms" fieldName="casesave"/>"><input type="hidden" id="id" name="id" value="${co.id}"><input type="hidden" id="type" name="type" value="1">
					...
					<div class="form-inline"><%@ include file="/WEB-INF/views/biz/case1piece1.jsp"%>
						...
						<div class="form-group newInput"><label>情况描述：</label> <textarea class="form-control" rows="4" style="resize: none; min-width: 300px" id="du-reason1" name="note"></textarea></div></div></form> <%@ include file="/WEB-INF/views/biz/case1piece.jsp"%>
...
<script>
	seajs.use("${scriptBasePath}/biz/case1add.js?r=<%=new Date()%>");
</script>
</html>