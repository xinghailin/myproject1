...
<input type="hidden" id="searchUrl"
	value="<ufa:url fieldName="bizcontractfinancelist" namespace="car-ms"/>">
<input type="hidden" id="editUrl" value="<ufa:url fieldName="bizcontractbaseview" namespace="car-ms"/>">
<input type="hidden" id="fullpaymentUrl" value="<ufa:url fieldName="fullpaymentsure" namespace="car-ms"/>">
<input type="hidden" id="settleaccountsUrl" value="<ufa:url fieldName="settleaccounts" namespace="car-ms"/>">
<input type="hidden" id="MaterialOutboundUrl" value="<ufa:url fieldName="MaterialOutbound" namespace="car-ms"/>">
...
<th style="text-align:center">档案编号</th>
        ...
        <tr>
			...
			<td>{{_operate id status status2 finance}}</td>
        </tr>
        {{/result}}
        </tbody>
    </table>
...
<script type="text/javascript">
    seajs.use("${scriptBasePath}/biz/bizcontractfinancepage.js?r=<%=new Date()%>");
</script>