...
<input type="hidden" id="searchUrl" value="<ufa:url fieldName="FINLISTONE_PROCUREMENTWEEKLY" namespace="car-ms"/>">
<style>
.selbox {
	width: 100%;
	display: flex;
...
<script type="text/javascript">
	...
	$.ajax({
		...
		$.each(data, function() {
			...
			marketPriceArr.push(this.marketPrice);
			setPriceArr.push(this.settlementPrice);
		});

		echars(name, year, timeArr, marketPriceArr, setPriceArr);
		function echars(name, year, timeArr, marketPriceArr, setPriceArr) {
			option = {
				title : {
					x : 'left',
					text : name + '车价变化',
