define(function(require, exports, module) {
	...
	datepickerUtil.datesTrigger('#sarrivetime', null, null);
	var PAGE_SIZE = 10;
	...
	function operate(id,status){
		...
		if (status==3||status==2) {
			var look = $("<a href='javascript:void(0);' target='_self' name='lookBtn' class='btn63_03' id='"+id+"'/>").html('<span>收到车辆</span>') ;
		}else if(status==4){
			var look = $("<a href='javascript:void(0);' target='_self' name='look2Btn' class='btn63_03' id='"+id+"'/>").html('<span>入中国库</span>') ;
		}
		var look3 = $("<a href='javascript:void(0);' target='_self' name='look3Btn' class='btn63_03' id='"+id+"'/>").html('<span>查看</span>') ;
