define(function(require, exports, module) {
	...
	handlebars.registerHelper('_formatDatetime', _formatSimpleDatetime);
	...
	function operate(id,pid){
		var edit= $("<a href='javascript:void(0);' target='_self' name='editBtn' class='btn63_01' id='"+id+"'/>").html('<span>入库</span>');
