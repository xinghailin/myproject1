	...
	methods = {
        init: function (options) {
           	return this.each(function() {
                ...
                $(opt.box).hide(); //隐藏容器
                $(document).delegate('.zoomInUp',opt.triggerEvent,function() { //元素点击事件
					//重置表单
//					if(opt.resetForm) {
//						var $obj = $(opt.box);
	...
	*/
	$.extend({  
	    ...
	    showLoading: function (t, w, h) { //显示加载
        	...
        	$body.stop().append('<div id="HLoading" style="width:'+w+'px;height:'+h+'px;line-height:'+h+'px;background:rgba(0,0,0,0.6);color:#fff;text-align:center;position:fixed;top:40%;left:60%;margin:'+margin+';">'+t+'</div>');
	    },
