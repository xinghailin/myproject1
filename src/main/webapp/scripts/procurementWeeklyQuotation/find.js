define(function(require, exports, module) {
	...
	function _addButton(id){
		var edit = $("<a href='javascript:void(0);' target='_self' name='viewBtn' class='btn63_03' id='"+id+"'/>").html('<span>查看</span>');
	...
	function skippage(){
		var queryUrl = $('#skipUrl').val();
		location.href=queryUrl; 
    }
	$("#btnReset").bind("click", reset);
	$("#skippage").bind("click", skippage);
	
	
	function viewCars(){
		location.href=$('#viewUrl').val()+"?id="+$(this).attr('id')+"&type=2";
	}
