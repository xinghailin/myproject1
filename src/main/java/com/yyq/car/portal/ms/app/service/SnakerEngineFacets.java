...
public class SnakerEngineFacets {
	...
	public void initFlows() {
        ...
        engine.process().deploy(StreamHelper.getStreamFromClasspath("flows/purshase.snaker"));
        
        engine.process().deploy(StreamHelper.getStreamFromClasspath("flows/loanApproval.snaker"));
	}
