	...
	function load(curPageNo, pageSize) {
		...
		$.ajax(queryUrl, {
			...
			if (response.result.length>0) {
				...
				$("#personagebuycar").html(rs.personagebuycar);
				$("#firmbuycar").html(rs.firmbuycar);
				$("#personagebuycarRatio").html("个人用车进店人数:"+rs.personagebuycarRatio);
				$("#firmbuycarRatio").html("单位用车进店人数:"+rs.firmbuycarRatio);
				var data = {
					      table:'datatable'
					   };
					   var chart = {
				...
				$("#th").html(0);
				$("#comesize").html(0);
				$("#personagebuycar").html(0);
				$("#firmbuycar").html(0);
				$("#personagebuycarRatio").html("个人用车进店人数:"+0);
				$("#firmbuycarRatio").html("单位用车进店人数:"+0);
				var data = {
					      table:'datatable'
					   };
					   var chart = {
