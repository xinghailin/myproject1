...
(function ($) {
    $.fn.bigic = function () {
        ...
        Bigic.prototype.show = function(){
            ...
            // 图片加载
            oImg.onload = function(){oThis.popup();   // 显示弹窗
        ...
        Bigic.prototype.popup = function(){
            ...
            sHtml += '<div id="popupBigic" class="popup-bigic" style="width:'+ this.nWinWid +'px;height:'+ this.nWinHei +'px;">' 
                  ...
                  +     '</div>'
                  +     '<img id="LoadingBigic" class="loading-bigic" src="'+contextPath+'/images/preloader.gif" />'
                  +  '</div>';
            $('body').append(sHtml);
        ...
        Bigic.prototype.zoom = function(){
            ...
            if(this.sImgStatus == 'min'){
                ...
                this.$img.css({'width': nWid +'px', 'height': nHei +'px', 'left': '50%', 'top': '50%', 'margin-top': 110-nHei/2+'px', 'margin-left': 200-nWid/2+'px'});
