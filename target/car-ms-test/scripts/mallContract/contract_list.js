...
define(function(require, exports, module) {
	...
	function _addButton(ncode){
		    var nbsp = "&nbsp;";
			var look = $("<a href='javascript:void(0);' target='_self' name='viewlookBtn' class='btn63_03' code='"+ncode+"'/>").html('<span>查看订单</span>');
	...
	function viewLook(){
		location.href=$('#lookUrl').val()+"?code="+$(this).attr('code');  
	}
