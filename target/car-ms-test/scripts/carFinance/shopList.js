define(function(require, exports, module) {
	...
	handlebars.registerHelper('_financeTypeY', _financeTypeY);
	handlebars.registerHelper('_financeTypeC', _financeTypeC);
	...
	//格式化样车金融或者 采购金融
	function _financeTypeY(financeType) {
		if (financeType === '2') {
			return '是';
		}else{
			return '';
	...
	//格式化样车金融或者 采购金融
	function _financeTypeC(financeType) {
		if (financeType === '1') {
			return '是';
		}else{
			return '';
