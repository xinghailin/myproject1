...
<input type="hidden" id="searchUrl" value="<ufa:url fieldName="LOOK_PROCUREMENTWEEKLY_URL" namespace="car-ms"/>">
...
<script type="text/javascript">
    seajs.use("${scriptBasePath}/procurementWeeklyQuotation/look.js?r=<%=new Date()%>");
</script>