...
<input type="hidden" id="searchUrl" value="<ufa:url fieldName="CLIENT_INFO_LST_ALL_DO" namespace="car-ms"/>">
<input type="hidden" id="editUrl" value="<ufa:url fieldName="CLIENT_INFO_VIEWALL" namespace="car-ms"/>">
...
<div class="tbul02_left02" style="width:30%">
		<div class="tab_txt01">
			<span class="td_01">门店：</span> <span class="td_02" style="margin-top: 4px;">
...
<script type="text/javascript">
    seajs.use("${scriptBasePath}/assetRepository/clientInfoAll.js?r=${ts}");
</script>