...
<input type="hidden" id="editUrl" value="<ufa:url fieldName="njndPurchaseEdit" namespace="car-ms"/>">
...
<th style="text-align:center;word-wrap:break-word;">采购车辆(purchaseNum)</th>
            <th style="text-align:center;word-wrap:break-word;">采购创建时间(purchaseTime)</th>
			...
			<th style="text-align:center;word-wrap:break-word;">需求车辆(requireNum)</th>
...
<th style="text-align:center;word-wrap:break-word;">商城合同编号(mallContractCode)</th>
            <th style="text-align:center;word-wrap:break-word;width:120px;">操作(opreate)</th>
        </tr>
        </thead>
        <tbody>
        {{#result}}
