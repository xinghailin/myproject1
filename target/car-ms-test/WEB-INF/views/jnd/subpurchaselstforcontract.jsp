...
<input type="hidden" id="searchUrl" value="<ufa:url fieldName="jndSubPurchaseLstForContractQuery" namespace="car-ms"/>">
<input type="hidden" id="backUrl" value="<ufa:url fieldName="jndPurchaseLstForContractIndex" namespace="car-ms"/>">
		  ...
		  <form name="searchForm" id="searchForm">	    
			<ul class="tb_ul02">
				...
				<div class="tbul02_right02" style="width:30%">
						<div class="tab_txt01">
							<span class="td_01">品牌(brand)：</span> <span class="td_02"
					...
					<div class="tbul02_left02" style="width:30%">
						<div class="tab_txt01">
							<span class="td_01">创建时间(createtime)：</span> <span
...
<div class="table_list" >
    <table cellpadding="0" cellspacing="0" class="tb_mian">
        ...
        <tr><th style="text-align:center">&nbsp;请选择(choose)&nbsp;</th>
			...
			<th style="text-align:center">采购计划名称(purchasePlanName)</th>
            <th style="text-align:center">首字母(initials)</th>
			<th style="text-align:center">品牌(brand)</th>
            <th style="text-align:center">型号(model)</th>
			<th style="text-align:center">版别(version)</th>
			<th style="text-align:center">调剂(dispensing)</th>
            <th style="text-align:center;width:20%;max-width:30%;">配置(configuration)</th>
			<th style="text-align:center">外观颜色(outcolor)</th>
			<th style="text-align:center">内饰颜色(incolor)</th>
            <th style="text-align:center">数量(num)</th>
            <th style="text-align:center">合同锁定数量(Lock num)</th>
			<th style="text-align:center">供应方(supplier)</th>
			<th style="text-align:center">总车价(totalPrice)</th>
            <th style="text-align:center">创建时间(creationTime)</th>
        </tr>
        </thead>
        <tbody>
        {{#result}}
...
<script type="text/javascript">
    seajs.use("${scriptBasePath}/jnd/subpurchaselstforcontract.js?v=<%=new Date()%>");
</script>