...
<input type="hidden" id="searchUrl" value="<ufa:url fieldName="jndblacksupplierQuery" namespace="car-ms"/>">
<input type="hidden" id="deleteUrl" value="<ufa:url fieldName="jndblacksupplierDel" namespace="car-ms"/>">
		  ...
		  <form name="searchForm" id="searchForm">	    
			<ul class="tb_ul02">
				...
				<div class="tbul02_right02" style="width:50%">
						<div class="tab_txt01">
							<span class="td_01" style="width: 220px;">供应方名称(supplier)：</span> <span class="td_02"
...
<div class="table_list" >
    <table cellpadding="0" cellspacing="0" class="tb_mian">
        <thead>
        <tr>
            <th style="text-align:center">供应方名称(supplier)</th>
            <th style="text-align:center">地区(area)</th>
 			<th style="text-align:center">创建时间(createTime)</th>
...
<script type="text/javascript">
    seajs.use("${scriptBasePath}/jnd/blacksupplierlst.js?v=<%=new Date()%>");
</script>