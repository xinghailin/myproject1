...
<div class="main_right" id="viewList" style="margin-left:300px;width: 1550px;height: 100%;"><head>
    <meta charset="UTF-8">
    <title>付款申请单查看-尾款</title>
</head>
<body>
<div class="box">
    <h2 class="buy-title">付款申请单查看-尾款</h2>
    <div class="content">
        <form name="editForm" id="editForm" method="POST" action="<ufa:url namespace="car-ms" fieldName="jndapplypaysave"/>">
        <input type="hidden" name="id" value="${ap.id}"><input type="hidden" name="subbuyid" id="subbuyid" value="${ap.subbuyid}">
            ...
            <div class="right" style="padding-top: 5px;"><div class="info">
                ...
                <div class="detail">
                    ...
                    <div>
                        ...
                        <span>${ap.finalpay}<c:out value="${_curr}"></c:out></span>
                    </div>
...
<script type="text/javascript">
    seajs.use("${scriptBasePath}/jnd/apayview.js");
</script>