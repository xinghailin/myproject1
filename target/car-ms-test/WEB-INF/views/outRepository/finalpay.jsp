...
<div class="mian_right-new" id="EA">
	<div class="rg_list">
		<h1 class="tt_h1" id="He">客户信息表&审核尾款</h1>
		<div class="tb_list">
		<ul class="tb_ul02">
		<form name="editForm" id="editForm" method="POST" action="<ufa:url namespace="car-ms" fieldName="SNAKER_HQFINFINALPAYDO"/>" enctype="multipart/form-data">
		...
		<li>
		   	...
		   	<li>
		  	  <div class="tab_txt01">
		  	  	<span class="td_01" style="width: 120px;">应付尾款：</span>
		  	  	<span style="line-height: 35px;width:300px;color: red;"><input type="hidden" id="finalpay" name="finalpay" value="${contract.finalpay}" />${contract.finalpay}&nbsp;元</span>
		  	  	<span class="td_01" style="width: 120px;"><label class="fc_red">*</label>实到尾款：</span>
		  	  	<span style="line-height: 35px;width:300px;"><input type="text" id="realfinalpay" name="realfinalpay" value="" />&nbsp;元</span>
			 </div>
		   	</li>
		  </form>
		</ul>
		...
		<div class="btnlist">
		<div style="width: 300px; margin: auto;"><a href="javascript:void(0);" class="btn63_01" id="saveBtn">确认到账审核通过</a>
...
<script type="text/javascript">
    seajs.use("${scriptBasePath}/outRepository/finalpay.js?r=<%=new Date()%>");
</script>
