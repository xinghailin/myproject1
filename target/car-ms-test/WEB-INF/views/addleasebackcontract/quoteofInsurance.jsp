...
<input type="hidden" id="searchUrl" value="<ufa:url fieldName="financialcontractslist" namespace="car-ms"/>">
<input type="hidden" id="editUrl" value="<ufa:url fieldName="bizcontractoperate" namespace="car-ms"/>">
<input type="hidden" id="baseUrl" value="<ufa:url fieldName="bizcontractbaseview" namespace="car-ms"/>">
		...
		<div class="tb_list">
			<form name="searchForm" id="searchForm">
				<ul class="tb_ul02">
					<li>
						<div class="tbul02_left02" style="width: 30%">
							<div class="tab_txt01"><span class="td_01">档案编号：</span> <span class="td_02" style="margin-top: 4px;"> <input name="filecode" class="input_text01" type="text"
									style="width: 180px;">
							</span></div>
					</div>
						<div class="tbul02_right02" style="width: 30%">
							<div class="tab_txt01"><span class="td_01">甲方：</span> <span class="td_02" style="margin-top: 4px;"> <input class="input_text01" name="name" class="input_text01"
									type="text" style="width: 180px;">
							</span></div>
					</div>
						<div class="tbul02_left02" style="width: 30%">
							<div class="tab_txt01"><span class="td_01">乙方：</span> <span class="td_02" style="margin-top: 4px;"> <input name="bname" class="input_text01" type="text"
									style="width: 180px;">
							</span></div>
					</div>
				</li>
					<li>
						<div class="tbul02_left02">
							<div class="tab_txt01"><span class="td_01">客户类别：</span> <span class="td_05" style="margin-top: 6px;"> <select name="workType">
						...
						<div class="tbul02_left02" style="width: 30%">
							<div class="tab_txt01"><span class="td_01">身份证号：</span> <span class="td_02" style="margin-top: 4px;"> <input name="identify" class="input_text01" type="text"
									style="width: 180px;">
							</span></div>
					</div>
				</li>
				...
				<div class="btnlist" style="margin-bottom: 20px;">
					<div style="width: 300px; margin: auto;"><a href="javascript:void(0);" id="btnSearch" class="btn63_01">查询</a> <a href="javascript:void(0);" id="btnReset"
...
<td>{{_operate id status finance}}</td>
        </tr>
        {{/result}}
        </tbody>
    </table>
...
<div id="J_Pagination"  class="pagelist"></div>
    ...
    seajs.use("${scriptBasePath}/addleasebackcontract/quoteofInsurance.js?r=<%=new Date()%>");
</script>