...
<input type="hidden" id="searchUrl" value="<ufa:url fieldName="LOOKCHECK_KRCAR_LIST" namespace="car-ms"/>">
...
<div class="table_list" >
    <table cellpadding="0" cellspacing="0" class="tb_mian">
        ...
        <tr>
            ...
            <td>{{_formatNopassreason status nopassreason}}</td>
        </tr>
        {{/result}}
        </tbody>
    </table>
...
<script type="text/javascript">
    seajs.use("${scriptBasePath}/krcar/lookcheck.js?r=<%=new Date()%>");
</script>