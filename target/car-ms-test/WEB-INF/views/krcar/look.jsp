...
<input type="hidden" id="searchUrl" value="<ufa:url fieldName="LOOK_KRCARENTER_URL" namespace="car-ms"/>">
			 ...
			 <form name="searchForm" id="searchForm"
				...
				<ul class="tb_ul02">
					...
					<li>
						...
						<div class="tbul02_right02" style="width: 25%">
							<div class="tab_txt01">
								<span class="td_01">是否超时：</span>
								<span class="td_02" style="margin-top: 4px;">
									<select id="outtimestatus" name="outtimestatus" style="width: 159px;height:25px">
									    <option value="">--请选择--</option>
									    <option value="1">未超过90天</option>
					   ...
					   <div class="tbul02_right02" style="width: 25%">
							<div class="tab_txt01">
								...
								<span class="td_02" style="margin-top: 4px;">
									<select id="status" name="status" style="width: 159px;height:25px">
									    <option value="">--请选择--</option>
									    <option value="2">库存中</option>
									    <option value="4">已出库</option>
...
<div class="table_list" >
    <table cellpadding="0" cellspacing="0" class="tb_mian">
        ...
        <tr>
            ...
            <td>{{_formatRemaindays remainstatus remaindays status}}</td>
        </tr>
        {{/result}}
        </tbody>
    </table>
...
<script type="text/javascript">
    seajs.use("${scriptBasePath}/krcar/look.js?r=<%=new Date()%>");
</script>