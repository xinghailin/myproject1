...
<input type="hidden" id="searchUrl" value="<ufa:url fieldName="casequery" namespace="car-ms"/>">
<input type="hidden" id="addUrl" value="<ufa:url fieldName="saleborrowlstforcasechoose" namespace="car-ms"/>">
<input type="hidden" id="flowUrl" value="<ufa:url fieldName="riskcaseflow" namespace="car-ms"/>">
<input type="hidden" id="operateUrl" value="<ufa:url fieldName="riskcaseview" namespace="car-ms"/>">
			...
			<form name="searchForm" id="searchForm">
				<ul class="tb_ul02">
					<li>
						...
						<div class="tbul02_left02" style="width: 30%">
							<div class="tab_txt01"><span class="td_01">乙方：</span> <span class="td_02" style="margin-top: 4px;"> <input name="bname" class="input_text01" type="text" style="width: 180px;">
							</span></div>
					</div>
				</li>
			</ul>
				<div class="btnlist" style="margin-bottom: 20px;">
					<div style="width: 400px; margin: auto;"><a href="javascript:void(0);" id="btnSearch" class="btn63_01">查询</a> <a href="javascript:void(0);" id="btnReset" class="btn63_02 margin_let10">重置</a>
					<a href="javascript:void(0);" id="btnAdd" class="btn63_01 margin_let10">新建融资租赁逾期案件</a>
					</div>
			</div>
		</form>
	</div>
...
<div id="J_Pagination"  class="pagelist"></div>
    ...
    seajs.use("${scriptBasePath}/biz/caselst.js?r=<%=new Date()%>");
</script>