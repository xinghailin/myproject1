...
<input type="hidden" id="searchUrl" value="<ufa:url fieldName="bizclientinfoquery" namespace="car-ms"/>">
<input type="hidden" id="editUrl" value="<ufa:url fieldName="bizclientinfoedit" namespace="car-ms"/>">
<input type="hidden" id="addUrl" value="<ufa:url fieldName="bizclientinfoadd" namespace="car-ms"/>">
		...
		<div class="tb_list">
		  <form name="searchForm" id="searchForm">	    
			<ul class="tb_ul02">
				...
				<div class="tbul02_left02" style="width:30%">
						<div class="tab_txt01">
							<span class="td_01">级别：</span> <span class="td_02" style="margin-top: 10px;">
				...
				<div class="tbul02_left02" style="width:30%">
						<div class="tab_txt01">
							<span class="td_01">类型：</span> <span class="td_02" style="margin-top: 10px;">
<c:choose>
...
<script type="text/javascript">
    seajs.use("${scriptBasePath}/biz/clientlst.js");
</script>