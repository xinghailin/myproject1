	...
	<div class="main_right" id="viewList" style="margin-left: 300px; height: 100%;">
		<div class="box">
			<div class="container">
				...
				<form name="editForm" id="editForm" method="POST" class="upload" action="<ufa:url namespace="car-ms" fieldName="bizcontractvin"/>"><input type="hidden" id="id" name="id" value="${co.id}"> <input type="hidden" id="zeropur" name="zeropur" value="${co.zeropur}">
                ...
                <label>品牌首字母：</label>${in.initials}
					...
					<div class="form-inline">
						<div class="form-group newInput"><label>车架号：</label><input type="hidden" id="carid" name="carid" value=""><input type="text" id="vin" name="vin" value="" readonly="readonly" class="form-control"><a href="javascript:;" class="btn btn-danger" role="button" id="chooseBtn">选车</a>
					</div>
				</div></form>
				<div class="du-btn"><a href="javascript:;" class="btn btn-danger" role="button" style="padding: 6px 30px" id="saveBtn">确定</a> <a href="javascript:;" class="btn btn-warning" role="button" style="padding: 6px 30px" id="backBtn">返回</a></div>
		</div>
	</div>
</div>
</body>
...
<script>
seajs.use("${scriptBasePath}/biz/contractvin.js?r=<%=new Date()%>");
</script>
</html>