...
<input type="hidden" id="searchUrl" value="<ufa:url fieldName="bizcontractquery_shopgroup" namespace="car-ms"/>">
...
<script type="text/javascript">
    seajs.use("${scriptBasePath}/biz/contractlst_shopgroup.js?r=<%=new Date()%>");
</script>