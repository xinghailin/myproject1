...
<input type="hidden" id="searchUrl" value="<ufa:url fieldName="COUNTCOMR_INDEX_CAR" namespace="car-ms"/>">
...
<div class="table_list" >
    <table cellpadding="0" cellspacing="0" class="tb_mian">
        ...
        <tr>
			...
			<th style="text-align:center">买车人数</th>
...
<table id="datatable">
<thead  hidden="hidden">
<tr><th></th><th>进店人数</th><th>买车人数</th></tr>
</thead>
<tbody  hidden="hidden">
...
<script type="text/javascript">
    seajs.use("${scriptBasePath}/report/reportBuyer.js");
</script>