...
<input type="hidden" id="searchUrl" value="<ufa:url fieldName="STORE_CARS_DO" namespace="car-ms"/>">
<input type="hidden" id="backUrl" value="<ufa:url fieldName="STORE_INDEX" namespace="car-ms"/>">
			...
			<ul class="tb_ul02">
				...
				<select id="status" name="status" style="width:100px;">
		  	  	  <option value="">--请选择--</option>
			             ...
			             <option value="4">购车出库中</option><option value="5">已销售</option>
		          </select>
								</span>
						</div>
					</div>
					<div class="tbul02_left02" style="width:30%;display: none;">
						<div class="tab_txt01">
...
<script type="text/javascript">
    seajs.use("${scriptBasePath}/shop/storecars.js?r=<%=new Date()%>");
</script>