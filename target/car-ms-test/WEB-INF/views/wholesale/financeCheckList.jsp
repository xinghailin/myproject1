...
<input type="hidden" id="searchUrl" value="<ufa:url fieldName="WHOLESALE_CHECKCARLISTFORFINANCE_METHOD" namespace="car-ms"/>">
<input type="hidden" id="financecheckviewUrl" value="<ufa:url fieldName="WHOLESALE_FINANCECHECK_PAGE" namespace="car-ms"/>">
						...
						<div class="tbul02_right02" style="width: 25%">
							<div class="tab_txt01">
								...
								<span class="" style="margin-top: 8px; width: 200px;">
									<select id="status2" name="status2" style="width: 159px; height: 25px">
...
<div class="table_list" >
    <table cellpadding="0" cellspacing="0" class="tb_mian">
        ...
        <tr>
            ...
            <td>{{_formatreason status2 reason2}}</td>
...
<script type="text/javascript">
    seajs.use("${scriptBasePath}/wholesale/financeCheckList.js?r=<%=new Date()%>");
</script>