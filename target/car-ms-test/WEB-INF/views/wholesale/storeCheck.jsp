...
<input type="hidden" id="storecheckUrl" value="<ufa:url fieldName="WHOLESALE_STORECHECKCAR_URL" namespace="car-ms"/>">
		...
		<div class="tb_list">
			<ul class="tb_ul02">
				...
				<form name="editForm" id="editForm" method="POST" >
					...
					<div style="">
						<textarea style="margin-left: 50px" cols="45" rows="3" placeholder="审核不通过的理由" name="reason1"
							id="reason1" value=""></textarea>
					</div>
				</form>
			</ul>
		</div>
...
<script type="text/javascript">
    seajs.use("${scriptBasePath}/wholesale/storeCheck.js?r=<%=new Date()%>");
</script>
