...
<input type="hidden" id="searchUrl" value="<ufa:url fieldName="WHOLESALE_CHECKCARLISTFORSTORE_METHOD" namespace="car-ms"/>">
<input type="hidden" id="storecheckviewUrl" value="<ufa:url fieldName="WHOLESALE_STORECHECK_PAGE" namespace="car-ms"/>">
...
<div class="table_list" >
    <table cellpadding="0" cellspacing="0" class="tb_mian">
        ...
        <tr>
            ...
            <td>{{_formatreason status2 reason1}}</td>
...
<script type="text/javascript">
    seajs.use("${scriptBasePath}/wholesale/storeCheckList.js?r=<%=new Date()%>");
</script>